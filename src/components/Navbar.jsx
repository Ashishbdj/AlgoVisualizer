...
export default function Navbar() {
  ...
  return (
    <nav className="bg-gray-900 text-white px-6 py-6 flex justify-between items-center fixed w-full h-28 top-0 z-50 shadow-md">
      <h1 className="text-5xl font-bold tracking-wide">AlgoViz</h1>

      {/* Desktop Menu */}
      <div className="hidden md:flex text-2xl space-x-8">
      ...
      {/* Mobile Menu */}
      {menuOpen && (
        <div className="absolute top-28 left-0 w-full bg-gray-800 flex flex-col items-center space-y-4 py-6 md:hidden">
